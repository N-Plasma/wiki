...
sidebar:
  ...
  exclude: false
---
I go by N-Plasma, TokenBro11400, or Noah11400 (should be clear what my real name is)

there isn't much to say, i know simple LUA, Python, and Blitz3D

(technically also BlitzBasic since B3D is based on it)

I only really have 4 Projects



- UDAADB - User Documentation (and) Automatic Assignment Database, a discord bot that intended to log users and make managing level based servers a bit easier. Status : On hold (burnout, general hatred of SQLite Python)
